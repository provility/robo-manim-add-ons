...
class ModelPolyLine(BaseModel):
    ...
    def from_points(points:list[ModelPoint]):
         model_poly_line = None
         
         def create():
             nonlocal model_poly_line
             model_poly_line = ModelPolyLine(points)
        
         def update():
             nonlocal model_poly_line
             model_poly_line.update(points)
